...
#include "Azuruk.h"
#include "AzurukEffectExplosion.h"


AAzurukEffectExplosion::AAzurukEffectExplosion(const class FPostConstructInitializeProperties& PCIP)
	: Super(PCIP)
{
...
void AAzurukEffectExplosion::BeginPlay()
{
	Super::BeginPlay();
...
void AAzurukEffectExplosion::Tick(float DeltaSeconds)
{
